...
public class AppointmentController {
	...
	public ResponseEntity<?> getAppointmentByCourse(@PathVariable Long courseId) {
		return new ResponseEntity<>(appointmentService.getAppointmentByCourseId(courseId),HttpStatus.OK);
	}
	...
	@PatchMapping("/updatestatus/{appointmentId}")
	public ResponseEntity<?> updateAppointmentStatus(@PathVariable Long appointmentId,@RequestParam String status){
		return new ResponseEntity<>(appointmentService.updateAppointmentStatus(appointmentId,status),HttpStatus.OK);
